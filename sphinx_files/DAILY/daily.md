...
#### 解決
userのmetadataを追加して、そのmetadataをsamlでやり取りをするようにルールを追加したところ解決


### 資料に対するRV
- やったことを新たに得られた知見とかを振り返り・まとめで折り込んでいく。
- 割と言われていることをやったのは重要だけど
自分がやっていく中で、もうちょっと深掘りや踏み込んだところがある。
- 自分がやって難しかったところとかを＋αで気付きをきちんと述べられると良いなと思いました。
- こういう効果が期待できる部分とかを深掘りする。身についたところを述べていく。
- P13角サーバーに認証情報を渡さなくてもサービスにアクセスすることができるので、各サービス認証情報をもたせなくてもできる。
これが手順の簡略や学習コストの低下のために、有用だよということがポイント。MSAに必須なわけではない。
